...
namespace BlazeloaderInstaller {
    class Configs {
        public const string MINECRAFT_VERSION = "1.9";
        public const string MAIN_CLASS = "net.minecraft.launchwrapper.Launch";

        public const string LITELOADER_VERSION = "1.9";
        ...
        public const string BLAZELOADER_VERSION = "beta1.1";
        ...
        public const string LAUNCH_WRAPPER = "net.minecraft:launchwrapper:1.12";
